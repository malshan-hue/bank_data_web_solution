...
{
    public class TransactionRepository<Transaction>
    {
        ...
        public ICollection<Transaction> RetrieveData(string procedureName, SqlParameter[] parameters = null)
        {
            ICollection<Transaction> data = new List<Transaction>();
                ...
                using (var sqlConnection = new SqlConnection(_connectionString))
                {
                    using (var sqlCommand = new SqlCommand(procedureName, sqlConnection))
                    {
                        try
                        {
                            ...
                            data = JsonConvert.DeserializeObject<ICollection<Transaction>>(jsonResult.ToString()) ?? new List<Transaction>();
                        }
                        catch (Exception)
                        {
